      ...
      >
          ...
          <motion.div variants={itemVariants} className="md:col-span-2">
            ...
            <div className="mt-6 flex space-x-4">
              ...
              <motion.a
                ...
                className="w-10 h-10 bg-gray-800 hover:bg-purple-600 rounded-lg flex items-center justify-center transition-all duration-300 group"
                whileHover={{ scale: 1.1, y: -2 }}
                whileTap={{ scale: 0.95 }}
              >
                <svg className="h-5 w-5 text-gray-300 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <motion.a
              ...
              className="mt-6 inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-6 py-3 rounded-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-xl"
          ...
          <motion.div variants={itemVariants}>
            ...
            <div className="space-y-3">
              <div className="flex items-center text-gray-300 text-sm">
                <svg className="h-4 w-4 mr-3 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                adnan.khan114@yahoo.com
              </div>
              <div className="flex items-center text-gray-300 text-sm">
                <svg className="h-4 w-4 mr-3 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        >
          <p className="text-gray-400 text-sm">
            © 2024 Adnan Khan. Crafted with ❤️ and lots of ☕
          </p>
        </motion.div>
      </motion.div>
    </footer>
